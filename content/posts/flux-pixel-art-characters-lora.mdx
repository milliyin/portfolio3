...
| Prompt | Output |
|---|---|
| `pixel art character, red hair, gray armor, no weapon, facing forward` | ![example 1](/blog/pixel-art-03.png) |
| `pixel art character, red hair, brown armor, no weapon, facing forward` | ![example 2](/blog/pixel-art-05.png) |
| `pixel art character, brown hair, blue clothing, no weapon, facing forward` | ![example 3](/blog/pixel-art-07.png) |
